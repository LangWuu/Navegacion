...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.message || "Algo salió mal, intenta de nuevo";
      setMensaje(errorMsg);
      setTipoMensaje("error");
    } finally {
    ...
    <div className="login">
      <div className="login__container">
        ...
        <div className="login__social">
          <button className="login__social-btn" type="button" onClick={() => alert('Próximamente con Google')}>
            <img
          ...
          <button className="login__social-btn" type="button" onClick={() => alert('Próximamente con Facebook')}>
            <img
