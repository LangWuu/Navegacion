...
const ExperienceDetail = () => {
  ...
  const experiencia = {
    ...
    nombre: "Alto Palací",
    descripcion:
      "Una experiencia única en las alturas de Valle del Cauca. Disfruta de vistas panorámicas, senderismo y la naturaleza colombiana.",
    categoria: "Aventura",
    ...
    resenas: [
      {
        ...
        rating: 5,
        comentario:
          "Increíble experiencia! El paisaje es espectacular y el guía muy amable.",
        fecha: "2024-01-15",
      },
      {
        id: 2,
        ...
        rating: 4,
        comentario:
          "Muy buena actividad, totalmente recomendada para los amantes de la naturaleza.",
        fecha: "2024-01-10",
      },
    ],
    guia: {
  ...
  return (
    <div className="experience-detail">
      ...
      <div className="experience-detail__hero">
        ...
        <div className="experience-detail__price-badge">
          {experiencia.isFree ? "GRATIS" : `$${experiencia.precio}`}
        </div>
      </div>
      ...
      <div className="experience-detail__content">
        ...
        <div className="experience-detail__section">
          ...
          <div className="experience-detail__reviews">
            {experiencia.resenas.map((r) => (
              <div key={r.id} className="experience-detail__review">
        ...
        <div className="experience-detail__footer">
          <div className="experience-detail__footer-content">
            ...
            <button
              className="btn btn--primary experience-detail__book-button"
